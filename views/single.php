...
<div class="entity_wrapper">
    ...
    <div class="entity_meta"><a href="#" target="_self"><?php echo date("d-m-Y", strtotime($row['newsDate'])); ?></a>, by: <a href="#" target="_self">
    <?php echo $row['newsEditor']?></a>
    </div>
    <!-- entity_meta -->
    ...
    <div class="entity_thumb">
        <img class="img-responsive" src="<?php echo $row['newsImage'];?>" alt="feature-top">
    </div>
    <!-- entity_thumb -->
    ...
    <div class="entity_content">
        <p>
        <?php $id=$_GET['id'];
        $query="SELECT newsContent From db_news WHERE id='$id' ";
        $result=mysqli_query($link, $query);
        $row=mysqli_fetch_assoc($result);
