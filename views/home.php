        ...
        <div class="row">
            <div class="col-md-7">
                <div class="feature_article_wrapper">
                    ...
                    <div class="feature_article_inner">
                        ...
                        <div class="feature_article_date"><a href="#" target="_self">Saddam</a>,<a href="#"
                                                                                                         target="_self">Aug
                            4, 2015</a></div>
                        <!-- feature_article_date -->

                        <div class="feature_article_content">
                            Bihar election result: Nitish, Lalu decimate BJP, say 'Bihar election results will have national Impact
                        </div>
            ...
            <div class="col-md-5">
                <div class="feature_static_wrapper">
                    ...
                    <div class="feature_article_inner">
                        ...
                        <div class="feature_article_title">
                            <h1><a href="single.html" target="_self">Kerala Tops In Governance Index, Bihar Ranks The Lowest: Report </a></h1>
                        </div>
                        <!-- feature_article_title -->
            ...
            <div class="col-md-5">
                <div class="feature_static_last_wrapper">
                    ...
                    <div class="feature_article_inner">
                        <div class="tag_lg blue"><a href="category.html">Recent</a></div>

                        <div class="feature_article_title">
                            <h1><a href="single.html" target="_self">Mahagatbandhan for rainbow coalition in Bihar for 2019 poll</a></h1>
                        </div>
                        <!-- feature_article_title -->
                        ...
                        <div class="feature_article_content">
                            Even as all eyes are set on how the NDA resolves the thorny seat-sharing issue, the rival ...
                        </div>
                        <!-- feature_article_content -->
